...
function About() {
  return (
    <div className={styles.about01} id="about">
        ...
        <div className={styles.one}>
          <div className={styles.text}>
            ...
            <p className={styles.text2}>
              ...
              <br />
              <br />
              Eager to embark on my tech adventure, I bring not just skills, but
              a creative mindset. Ready to roll up my sleeves, I'm here to
